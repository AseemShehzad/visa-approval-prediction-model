...
with gr.Blocks() as interface:
    with gr.Row():
        ...
        # Sponsor
        sponsor = gr.Dropdown(choices=['Other', 'Family', 'Loan', 'Self', 'University', 'Employer'], label="Sponsor", placeholder="Who's sponsoring you?")
    ...
    with gr.Row():
        # Visa attempt
        visa_attempt = gr.Dropdown(choices=["First", "Second", "Third", "Fourth or more"], label="Visa Attempt", placeholder="How many times have you applied for visa?")
        gr.Text(" ")
